...
/**
 */
public class ClearAllBeansMethodGenerator extends AbstractRedisMethodGenerator {
    ...
    public void addInterfaceAndClassImpl(Interface interfaze, TopLevelClass topLevelClass)  {
        ...
        try {
            String body = FreeMarkerUtil.getStringFromTemplate(dir, "clearAllBean.ftl", templateParaMap);
