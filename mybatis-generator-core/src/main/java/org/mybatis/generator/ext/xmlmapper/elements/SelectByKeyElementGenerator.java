 ...
 * 
 */
public class SelectByKeyElementGenerator extends
        AbstractXmlElementGenerator {

    public SelectByKeyElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", GenUtil.getSelectByKeyMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.XML_TYPE))); //$NON-NLS-1$
