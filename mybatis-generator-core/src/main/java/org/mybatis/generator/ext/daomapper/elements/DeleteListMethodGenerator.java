...
/**
 */
public class DeleteListMethodGenerator extends AbstractDaoMapperMethodGenerator {
    ...
    protected Method generateMethod(Set<FullyQualifiedJavaType> importedTypes) {
        ...
        method.setName(GenUtil.getDeleteByListMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.DAO_TYPE));
    ...
    public void addTopLevelClassElements(TopLevelClass topLevelClass) {
        ...
        //sb.append("return ");
        sb.append("deleteAll(\"");
        sb.append(GenUtil.getDeleteByListMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.XML_TYPE));
        sb.append("\", ");
