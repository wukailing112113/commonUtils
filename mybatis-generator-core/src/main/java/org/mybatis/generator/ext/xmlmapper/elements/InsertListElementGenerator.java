...
public class InsertListElementGenerator extends AbstractXmlElementGenerator {
    ...
    public InsertListElementGenerator(boolean isSimple) {
        super();
...
//        }
        ...
        answer.addAttribute(new Attribute(
                "id", GenUtil.getAddBeanMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.XML_TYPE) + "List"));
        ...
        valuesClause.append("\n\t<foreach collection=\"list\" index=\"index\" item=\"item\" separator=\",\"> "); //$NON-NLS-1$
        valuesClause.append("\n\t  (") ;
