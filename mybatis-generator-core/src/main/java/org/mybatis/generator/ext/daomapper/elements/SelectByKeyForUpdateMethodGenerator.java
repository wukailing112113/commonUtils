...
/**
 */
public class SelectByKeyForUpdateMethodGenerator extends AbstractDaoMapperMethodGenerator {
    ...
    protected Method generateMethod(Set<FullyQualifiedJavaType> importedTypes) {
        ...
        method.setName(GenUtil.getSelectByKeyMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.DAO_TYPE)+"ForUpdate");
    ...
    public void addTopLevelClassElements(TopLevelClass topLevelClass) {
        ...
        if (introspectedColumns.size() == 1) {
            ...
            sb.append("return ");
            sb.append("getPojoById(\""+ GenUtil.getSelectByKeyMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.XML_TYPE) + "ForUpdate\"");
            sb.append(", ");
