...
/**
 */
public class DeleteBeanMethodGenerator extends AbstractRedisMethodGenerator {
    ...
    protected Method generateMethod(Set<FullyQualifiedJavaType> importedTypes) {
        ...
        method.setName(GenUtil.getDeleteByKeyMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.REDIS_TYPE));
    ...
    public void addInterfaceAndClassImpl(Interface interfaze, TopLevelClass topLevelClass)  {
        ...
        try {
            String body = FreeMarkerUtil.getStringFromTemplate(dir, "deleteBean.ftl", templateParaMap);
