...
/**
 */
public class GetTotalBeanMethodGenerator extends AbstractRedisMethodGenerator {
    ...
    protected Method generateMethod(Set<FullyQualifiedJavaType> importedTypes) {
        ...
        method.setName(GenUtil.getSelectCountMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.REDIS_TYPE));
    ...
    public void addInterfaceAndClassImpl(Interface interfaze, TopLevelClass topLevelClass) {
        ...
        templateParaMap.put("getTotalBeanDaoMethod", GenUtil.getSelectCountMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.DAO_TYPE));
        ...
        try {
            String body = FreeMarkerUtil.getStringFromTemplate(dir, "getTotalBean.ftl", templateParaMap);
