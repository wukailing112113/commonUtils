...
/**
 */
public class InitMaxBeanIdMethodGenerator extends AbstractRedisMethodGenerator {

    protected Method generateMethod(Set<FullyQualifiedJavaType> importedTypes) {
        Method method = new Method();
        method.setName(GenUtil.getInitBeanMaxIdMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.REDIS_TYPE));
    ...
    public void addInterfaceAndClassImpl(Interface interfaze, TopLevelClass topLevelClass) {
        ...
        templateParaMap.put("findMaxIdDaoMethodName", GenUtil.getMaxIdMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.DAO_TYPE));
        ...
        methodImpl.addAnnotation("@PostConstruct");
        try {
            String body = FreeMarkerUtil.getStringFromTemplate(dir, "initMaxBeanId.ftl", templateParaMap);
